...
def activate(filepath):
    ...
    cv2.imwrite('processing/staff_recs_img.png', staff_recs_img)
    ...
    cv2.imwrite('processing/staff_boxes_img.png', staff_boxes_img)
    ...
    cv2.imwrite('processing/sharp_recs_img.png', sharp_recs_img)
    ...
    cv2.imwrite('processing/flat_recs_img.png', flat_recs_img)
    ...
    cv2.imwrite('processing/quarter_recs_img.png', quarter_recs_img)
    ...
    cv2.imwrite('processing/half_recs_img.png', half_recs_img)
    ...
    cv2.imwrite('processing/whole_recs_img.png', whole_recs_img)
    ...
    cv2.imwrite('processing/res.png', img)
